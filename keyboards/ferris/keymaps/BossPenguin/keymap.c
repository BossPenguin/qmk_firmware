...
const uint16_t PROGMEM klsemi_combo[] = {KC_K, KC_L, KC_SCLN, COMBO_END};
...
combo_t key_combos[] = {
    ...
    [COMBO_ENTER] = COMBO(klsemi_combo, KC_ENTER),
 ...
 [_LAYER0] = LAYOUT(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, LSFT_T(KC_A), KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, LSFT_(KC_SCLN), LCTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_N, LGUI_T(KC_M), LALT_T(KC_COMM), RCTL_T(KC_DOT), RALT_T(KC_SLSH), TT(2), KC_BSPC, KC_SPC, MO(1)),
