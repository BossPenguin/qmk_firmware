...
[_LAYER6] = LAYOUT(LCTL(LALT(KC_DEL)), LGUI(KC_LEFT), LGUI(KC_RIGHT), LGUI(LSFT(KC_LEFT)), LGUI(LSFT(KC_RIGHT)), LGUI(LCTL(KC_D)), LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RIGHT)), LGUI(KC_TAB), LALT(KC_ESC), KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, LGUI(LSFT(KC_4)), LGUI(LSFT(KC_3)), LGUI(LSFT(KC_2)), LGUI(KC_L), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LCTL(KC_LEFT), LCTL(KC_RIGHT), LGUI(KC_TAB), LGUI(LSFT(KC_GRV)))
