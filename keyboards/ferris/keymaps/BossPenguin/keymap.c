...
[_LAYER3] = LAYOUT(KC_ESC, KC_BTN2, KC_MS_UP, KC_BTN1, KC_WH_U, KC_HOME, KC_END, KC_UP, KC_NO, KC_DEL, KC_TAB, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT, KC_NO, KC_NO, KC_PSCR, KC_WH_L, KC_WH_R, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO),
...
[_LAYER4] = LAYOUT(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_H, KC_J, KC_K, KC_L, LSFT_T(KC_SCLN), KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_N, LGUI_T(KC_M), LALT_T(KC_COMM), RCTL_T(KC_DOT), RALT_T(KC_SLSH), KC_T, KC_SPC, KC_ESC, KC_I),
 ...
 [_LAYER5] = LAYOUT(KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, LSFT_T(KC_A), KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, LSFT_T(KC_O), LCTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_K, LGUI_T(KC_M), LALT_T(KC_COMM), RCTL_T(KC_DOT), RALT_T(KC_SLSH), TT(2), KC_BSPC, KC_SPC, MO(1)),
