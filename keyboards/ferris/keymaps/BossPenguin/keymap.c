...
[_LAYER3] = LAYOUT(KC_ESC, KC_BTN2, KC_MS_UP, KC_BTN1, KC_WH_U, KC_HOME, KC_END, KC_UP, LGUI(LSFT(KC_4)), KC_DEL, KC_TAB, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_MPLY, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT, LGUI(LSFT(KC_2)), LGUI(KC_L), KC_PSCR, KC_WH_L, KC_WH_R, KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, LGUI(LSFT(KC_3)), KC_NO, KC_TRNS, KC_TRNS, KC_NO),
